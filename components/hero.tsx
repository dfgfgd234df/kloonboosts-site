        ...
        <div className="mx-auto w-full max-w-[1159px] px-2 flex items-center">
          <div className="flex flex-row items-center">
            <div className="lg:w-1/2 flex !float-left flex-col gap-3 md:items-start items-center md:text-start text-center">
              ...
              We provide Fast and reliable Discord Services. We&#39;ve providing Discord Boosts and Member boosts for years for the lowest cost, grab your boosts at KloonBoosts!
              </p>
              <Link
                activeClass="active"
                to="pricing"
